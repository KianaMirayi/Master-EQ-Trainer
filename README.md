...
## 🎵 内置音频版权说明与免责声明 (Audio Disclaimer)

本项目内置引用的示范音轨（位于 `TrackManager.ts`）仅供听觉训练演示、技术评估与个人非商业性交流学习使用，版权归原作者及版权方所有。
如需在生产环境商用或进行二次分发，请使用自行拥有授权的音源资产，或使用本应用提供的“本地音轨导入”功能加载您自己的音频文件。
