...
const LoaderAnimation: React.FC<LoaderAnimationProps> = ({
  ...
  return (
    <div className="loader-animation-container" style={{ opacity }}>
      <style>{`
        .loader-animation-container {
          ...
          width: 7.3em;
          height: 1.5em; /* Ensure it doesn't clip */
          filter: drop-shadow(0 0 0.05em var(--shine-color));
        }

        .loader-animation-container .text {
          display: flex;
          align-items: center;
          justify-content: center;
          text-align: center;
        ...
        .loader-animation-container .text:nth-child(1) {
        ...
        .loader-animation-container .text:nth-child(2) {
        ...
        .loader-animation-container .text:nth-child(3) {
        ...
        .loader-animation-container .text:nth-child(4) {
        ...
        .loader-animation-container .text:nth-child(5) {
        ...
        .loader-animation-container .text:nth-child(6) {
        ...
        .loader-animation-container .text:nth-child(7) {
        ...
        .loader-animation-container .text:nth-child(8) {
        ...
        .loader-animation-container .text:nth-child(9) {
        ...
        .loader-animation-container .line {
          position: relative;
          display: flex;
          align-items: center;
          justify-content: center;
        ...
        .loader-animation-container .line::before {
          content: "";
          position: absolute;
          height: 100%;
          width: 100%;
        ...
        .loader-animation-container .line::after {
          content: "";
          position: absolute;
          height: 100%;
          width: 100%;
